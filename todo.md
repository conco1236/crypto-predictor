...
- [ ] Thêm nút xuất vùng biểu đồ P&L thành PNG và tài liệu PDF
- [ ] Bổ sung lưu, đổi tên, xóa và chọn nhiều scenario dry-run
- [ ] Thêm bảng so sánh kết quả dry-run scenario và không lưu secrets
- [ ] Kiểm thử export, scenario persistence, responsive/runtime và Pro-ready release checks
- [ ] Commit và push code mới lên repository GitHub đã cấu hình
